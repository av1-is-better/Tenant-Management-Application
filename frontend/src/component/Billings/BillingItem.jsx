                      ...
                      <button
                        ...
                        onClick={() => {
                          setBillingInfo({
                            ...
                            power_charge: item.power_charge,
                            water_charge: item.water_charge,
                            other_charge: item.other_charge,
                            power_consumed: item.power_consumed,
                            power_unit_cost: item.power_unit_cost,
                            total: item.total,
                            message_note: item.message_note,
                          });
                          setCurrentSection("UpdateBill");
                        }}
                      >
                        <FaEdit /> Edit
                      </button>
